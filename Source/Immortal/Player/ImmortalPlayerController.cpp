...
void AImmortalPlayerController::BeginPlay()
{
	...
	FireComponent = PossessedCharacter->FindComponentByClass<UParabolicWeaponControllerComponent>();
}
...
{
	AImmortalCharacter* ClosestCharacter = Cast<AImmortalCharacter>(GetClosestPawn());
